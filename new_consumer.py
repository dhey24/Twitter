...
class StdOutListener(tweepy.StreamListener):
    ...
    def on_data(self, data):
        ...
        if tweet_obj and is_good_tweet(tweet_obj) and \
            no_ignored_keywords(tweet_obj) and not_too_old(tweet_obj) and \
            no_banned_keywords(tweet_obj) and good_location(tweet_obj) and \
            good_text_indicators(tweet_obj):
