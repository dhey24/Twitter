...
IGNORED_KEYWORDS = ['xxx', 'baby','€','£','bieber','pokemon', 'tpp', 'vgc09', 'quiz', '_rt_']

# Need to populate with US specific locations - can be found on the tweet object
EU_LOCATIONS = ["charleston, sc","jacksonville, fl","chicago, il","boston, ma","durham, nc", "chapel hill, nc", "raleigh, nc", "new york, ny", "brooklyn new york", "new york city", "nyc"]
